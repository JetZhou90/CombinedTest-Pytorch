...
checkpoint = torch.load("logs/EfficientNet/version_2/checkpoints/_ckpt_epoch_153.ckpt",map_location='cpu')
experiment.load_state_dict(checkpoint['state_dict'])
model = experiment.model
model.requires_grad_(False)
model.eval()

for image in os.listdir('D:/Projects/seal_validation/image/')[:-1:100]:
    path = 'D:/Projects/seal_validation/image/'+image
